...
class RISSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class RISExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RISDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new RISStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RISDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RISDateTimeConverter dateTimeConverter = new RISStandardDateTimeConverter();

    public RISExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RISExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RISMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RISHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RISExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RISHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }

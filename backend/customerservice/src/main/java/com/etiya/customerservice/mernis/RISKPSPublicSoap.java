...
public class RISKPSPublicSoap
{
    ...
    public RISKPSPublicSoap(){}

    public RISKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RISKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RISExtendedSoapSerializationEnvelope envelope= new RISExtendedSoapSerializationEnvelope(RISExtendedSoapSerializationEnvelope.VER11);
